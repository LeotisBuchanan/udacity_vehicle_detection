...
candidate_windows = computeBoxes(img)
...
box_list  = windowManager.search_windows(img,
                                         candidate_windows,
                                         classifier,
                                         featureGenerator,
                                         settingsDict)
...
print("total number of boxes " + str(len(box_list)))

for can in box_list:
    cv2.rectangle(image, can[0], can[1], (0,0,255),6)
...
#for can in candidate_windows:
#    cv2.rectangle(draw_img, can[0], can[1], (0,0,255),6)
